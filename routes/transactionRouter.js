...
const {initialPayment,verifyPayment, payBalance}= require('../controller/transaction')
 ...
 *     responses:
 *       201:
 *         description: balance initialized successfully.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: balance initialized successfully
 *                 data:
 *                   type: object
 *                   properties:
 *                     reference:
 ...
 *                 message:
 *                   type: string
 *                   example: Error paying balance
 */
transactionrouter.post("/initialize/:tenantId/:landlordId/:listingId", payBalance)
