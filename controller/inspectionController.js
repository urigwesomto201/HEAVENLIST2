...
// if (!landlord.email) {
//   return res.status(400).json({ message: 'Landlord email is not defined' });
// }

// if (!tenant.email) {
//   return res.status(400).json({ message: 'Tenant email is not defined' });
// }
...
// await sendEmail({
//   to: tenant.email,
//   subject: 'Inspection Scheduled Successfully',
//   text: `
//     Hello ${tenant.fullName},

//     Your inspection for the property "${listing.title}" has been scheduled successfully.
    
//     Date: ${scheduledDate}
//     Time Range: ${timeRange}

//     The landlord (${landlord.fullName}) will follow up with you to confirm the appointment.
