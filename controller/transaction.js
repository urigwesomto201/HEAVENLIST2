...
//     const listing = await listingModel.findOne({
//       where: { id: listingId },
//       attributes: ['id', 'price', 'balance', 'landlordId', 'status', 'isAvailable'],
//     });
...
//     // Fetch the most recent transaction for the tenant, landlord, and listing
//     const existingTransaction = await transactionModel.findOne({
//       where: { tenantId, landlordId, listingId },
//       order: [['createdAt', 'DESC']], // Ensure the latest transaction is fetched
//     });
